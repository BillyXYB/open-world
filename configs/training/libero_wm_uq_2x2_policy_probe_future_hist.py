"""LIBERO world-model training config: UQ head + future-in-history augmentation, on policy-probe 2x2 data.

Same architecture as libero_wm_uq_2x2_future_hist.py but the dataset points to
...
def get_args() -> LiberoWMArgs:
    args = LiberoWMArgs(
        ...
        tag="libero_wm_uq_2x2_policy_probe_future_hist_v0",
    )
    return args
