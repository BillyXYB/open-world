#!/bin/bash
#
#SBATCH --job-name=replay-droid-epi-single-hist
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
...
# ===== CHECKPOINT =====
# droid_wm_uq_single_hist.py (v1: down_sample=3 fix) hasn't been trained yet
# as of writing this job; run jobs/train_wm_uq_flow_matching_4_gpu_single_hist_droid.sh first.
CKPT_DIR="checkpoints/wm_droid/droid_flow_matching_uq_single_hist_v1"
...
# ===== REPLAY (epistemic UQ: single_history, on DROID) =====
