#!/bin/bash
#
#SBATCH --job-name=wm-uq-2x2-single-hist
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:4
...
STAT_FILE="data/libero_uq_2x2/stat.json"
if [ ! -f "$STAT_FILE" ]; then
...
MANIFEST_FILE="data/libero_uq_2x2/test_manifest_by_cell.json"
...
uv run accelerate launch --num_processes 4 \
    ...
    --config configs/training/libero_wm_uq_2x2_single_hist.py
