...
class CtrlWorldDiffusionPipeline(StableVideoDiffusionPipeline):
    ...
    def __call__(
        ...
        # denoising of shortcut model
        # TODO: suppoprt multi-step denoisng. Now only support 1 step
    ...
    def short_cut_solver(self, num_inference_steps, latents
        ...
        if num_inference_steps <= 1:
            ...
            # Uniform time grid from t=0 to t=1 in num_inference_steps steps
            ...
            # Distance conditioning: dt_base = log2(num_inference_steps) + 1
            # matching the bootstrap training convention
